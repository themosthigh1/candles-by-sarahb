  ...
  return (
    <div>
      ...
      <div className='px-6 sm:px-12 md:px-20 lg:px-36 mx-auto text-black mb-10'>
        ...
        <p>This Privacy Policy describes how www.candlesbysarahb.com (the “Site” or “we”) collects, uses, and discloses your Personal Information when you visit or make a purchase from the Site.
        </p>

        <h2 className="text-xl font-semibold my-2">COLLECTING PERSONAL INFORMATION</h2>

        <p>When you visit the Site, we collect certain information about your device, your interaction with the Site, and information necessary to process your purchases. We may also collect additional information if you contact us for customer support. In this Privacy Policy, we refer to any information that can uniquely identify an individual (including the information below) as “Personal Information”. See the list below for more information about what Personal Information we collect and why
        </p>

        <h2 className="text-xl font-semibold my-2">DEVICE INFORMATION</h2>
        ...
        <h2 className="text-xl font-semibold my-2">ORDER INFORMATION</h2>
        ...
        <h2 className="text-xl font-semibold my-2">MINORS</h2>
        ...
        <h2 className="text-xl font-semibold my-2">SHARING PERSONAL INFORMATION</h2>
        We share your Personal Information with service providers to help us provide our services and fulfill our contracts with you, as described above. For example:
        •We may share your Personal Information to comply with applicable laws and regulations, to respond to a subpoena, search warrant or other lawful request for information we receive, or to otherwise protect our rights.

        <h2 className="text-xl font-semibold my-2">USING PERSONAL INFORMATION</h2>
        We use your personal Information to provide our services to you, which includes: offering products for sale, processing payments, shipping and fulfillment of your order, and keeping you up to date on new products, services, and offers.

        <h2 className="text-xl font-semibold my-2">RETENTION</h2>
        When you place an order through the Site, we will retain your Personal Information for our records unless and until you ask us to erase this information. For more information on your right of erasure, please see the ‘Your rights’ section below.

        <h2 className="text-xl font-semibold my-2">COOKIES</h2>
        ...
        <h2 className="text-xl font-semibold my-2">DO NOT TRACK</h2>
        Please note that because there is no consistent industry understanding of how to respond to “Do Not Track” signals, we do not alter our data collection and usage practices when we detect such a signal from your browser.
        <h2 className="text-xl font-semibold my-2">CHANGES</h2>
